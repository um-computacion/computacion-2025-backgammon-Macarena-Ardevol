def main():
    ...
    try:
        ...
        while running:
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    if idx_hover is None:
                        selected_idx = None
                        # clic en panel o fuera del tablero: no hacemos nada
                        continue
                    ...
                    if origin_idx is None:
                        ...
                        if pip < 1 or pip > 6:
                            message = f"Movimiento inválido: pip {pip} fuera de 1..6"
                        else:
                            if not board.can_move(origin_idx, pip, current_color):
            ...
            # Estado / mensajes (abajo del panel)
